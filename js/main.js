...
if (__title) {
    localStorage.setItem('title' + getUrlParam('id'), __title);
    location.search = '?id=' + getUrlParam('id');
}
if (location.port != "") {
    __API = ["http://localhost:5000/api/buyershow"]
}
;
